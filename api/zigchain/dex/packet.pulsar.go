...
var (
	...
	fd_DexPacketData_no_data protoreflect.FieldDescriptor
)

func init() {
	file_zigchain_dex_packet_proto_init()
	md_DexPacketData = File_zigchain_dex_packet_proto.Messages().ByName("DexPacketData")
	fd_DexPacketData_no_data = md_DexPacketData.Fields().ByName("no_data")
}
...
func (x *DexPacketData) slowProtoReflect() protoreflect.Message {
	mi := &file_zigchain_dex_packet_proto_msgTypes[0]
...
func (x *fastReflection_DexPacketData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Packet != nil {
		...
		case *DexPacketData_NoData:
			...
			if !f(fd_DexPacketData_no_data, value) {
				return
			}
		}
	}
...
func (x *fastReflection_DexPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "zigchain.dex.DexPacketData.no_data":
		if x.Packet == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zigchain.dex.DexPacketData"))
		}
		panic(fmt.Errorf("message zigchain.dex.DexPacketData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DexPacketData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message zigchain.dex.DexPacketData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DexPacketData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "zigchain.dex.DexPacketData.packet":
		if x.Packet == nil {
			return nil
		}
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in zigchain.dex.DexPacketData", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_zigchain_dex_packet_proto_init()
	md_NoData = File_zigchain_dex_packet_proto.Messages().ByName("NoData")
}
...
func (x *NoData) slowProtoReflect() protoreflect.Message {
	mi := &file_zigchain_dex_packet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_NoData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zigchain.dex.NoData"))
		}
		panic(fmt.Errorf("message zigchain.dex.NoData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_NoData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message zigchain.dex.NoData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_NoData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zigchain.dex.NoData", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: zigchain/dex/packet.proto
...
func (*DexPacketData) Descriptor() ([]byte, []int) {
	return file_zigchain_dex_packet_proto_rawDescGZIP(), []int{0}
}
...
func (*NoData) Descriptor() ([]byte, []int) {
	return file_zigchain_dex_packet_proto_rawDescGZIP(), []int{1}
}

var File_zigchain_dex_packet_proto protoreflect.FileDescriptor

var file_zigchain_dex_packet_proto_rawDesc = []byte{
	0x0a, 0x19, 0x7a, 0x69, 0x67, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x64, 0x65, 0x78, 0x2f, 0x70,
	0x61, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x7a, 0x69, 0x67,
	0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x64, 0x65, 0x78, 0x22, 0x4a, 0x0a, 0x0d, 0x44, 0x65, 0x78,
	0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2f, 0x0a, 0x07, 0x6e, 0x6f,
	0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x7a, 0x69,
	0x67, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x64, 0x65, 0x78, 0x2e, 0x4e, 0x6f, 0x44, 0x61, 0x74,
	...
	0x8f, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x7a, 0x69, 0x67, 0x63, 0x68, 0x61, 0x69, 0x6e,
...
var (
	file_zigchain_dex_packet_proto_rawDescOnce sync.Once
	file_zigchain_dex_packet_proto_rawDescData = file_zigchain_dex_packet_proto_rawDesc
)

func file_zigchain_dex_packet_proto_rawDescGZIP() []byte {
	file_zigchain_dex_packet_proto_rawDescOnce.Do(func() {
		file_zigchain_dex_packet_proto_rawDescData = protoimpl.X.CompressGZIP(file_zigchain_dex_packet_proto_rawDescData)
	})
	return file_zigchain_dex_packet_proto_rawDescData
}

var file_zigchain_dex_packet_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_zigchain_dex_packet_proto_goTypes = []interface{}{
	(*DexPacketData)(nil), // 0: zigchain.dex.DexPacketData
	(*NoData)(nil),        // 1: zigchain.dex.NoData
}
var file_zigchain_dex_packet_proto_depIdxs = []int32{
	1, // 0: zigchain.dex.DexPacketData.no_data:type_name -> zigchain.dex.NoData
...
func init() { file_zigchain_dex_packet_proto_init() }
func file_zigchain_dex_packet_proto_init() {
	if File_zigchain_dex_packet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_zigchain_dex_packet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zigchain_dex_packet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NoData); i {
			case 0:
				return &v.state
			case 1:
	...
	file_zigchain_dex_packet_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_zigchain_dex_packet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zigchain_dex_packet_proto_goTypes,
		DependencyIndexes: file_zigchain_dex_packet_proto_depIdxs,
		MessageInfos:      file_zigchain_dex_packet_proto_msgTypes,
	}.Build()
	File_zigchain_dex_packet_proto = out.File
	file_zigchain_dex_packet_proto_rawDesc = nil
	file_zigchain_dex_packet_proto_goTypes = nil
	file_zigchain_dex_packet_proto_depIdxs = nil
}
